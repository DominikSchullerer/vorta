    ...
    // keyboard_input
    V_API bool8_t input_is_key_down(keys_t key);
    V_API bool8_t input_is_key_up(keys_t key);
    V_API bool8_t input_was_key_down(keys_t key);
    V_API bool8_t input_was_key_up(keys_t key);

    void input_process_key(keys_t key, bool8_t pressed);

    // mouse input
    V_API bool8_t input_is_button_down(buttons_t button);
    V_API bool8_t input_is_button_up(buttons_t button);
    V_API bool8_t input_was_button_down(buttons_t button);
    V_API bool8_t input_was_button_up(buttons_t button);
